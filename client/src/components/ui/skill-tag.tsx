...
export function SkillTag({
  ...
  const skillTag = (
    <div
      className={cn(
        "skill-tag inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-sm font-medium transition-all duration-200 min-w-0 flex-shrink-0 group",
        colorClasses[color],
        buttonClass,
        className
      )}
    ...
    >
      ...
      {onRemove && (
        <button
          ...
          className="flex-shrink-0 ml-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 hover:bg-black/10 rounded-full p-0.5"
          title="Remove skill"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
