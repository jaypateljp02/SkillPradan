...
export function LearningSession() {
  ...
  return (
    <div>
      ...
      <div className="mt-4 bg-primary bg-opacity-5 rounded-lg p-4 border border-primary border-opacity-20">
      ...
      {comingWeekSessions.slice(1).map(session => (
        <div key={session.id} className="mt-4 bg-white rounded-lg p-4 border border-neutral-200">
          <div className="flex items-start">
            <div className="flex-shrink-0">
              <UserAvatar 
