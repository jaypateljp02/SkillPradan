...
export default function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-50">
      <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto shadow-lg rounded-xl overflow-hidden">
        {/* Form Column */}
        <div className="w-full md:w-2/5 p-6 md:p-8 flex items-center justify-center order-2 md:order-1 bg-white">
          <div className="w-full max-w-md">
            <div className="text-center mb-6">
              <div className="flex flex-col items-center justify-center">
                <img src={logoImage} alt="Skill Pradan Logo" className="h-20 w-20 mb-4" />
        ...
        <div className="hidden md:flex md:w-3/5 bg-gradient-to-br from-primary-800 to-primary-600 text-white p-8 flex-col justify-center order-1 md:order-2">
